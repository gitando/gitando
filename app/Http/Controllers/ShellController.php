...
class ShellController extends Controller
{
    ...
    */
    public function setup(string $server_id)
    {
        ...
        $script = Storage::get('gitando/setup.sh');
    ...
    */
    public function deploy(string $site_id)
    {
        ...
        $script = Storage::get('gitando/deploy.sh');
    ...
    */
    ...
    {
        $script = Storage::get('gitando/rootreset.sh');
    ...
    */
    ...
    {
        $script = Storage::get('gitando/newsite.sh');
    ...
    */
    ...
    {
        $script = Storage::get('gitando/delsite.sh');
    ...
    */
    ...
    {
        $script = Storage::get('gitando/sitepass.sh');
    ...
    */
    ...
    {
        $script = Storage::get('gitando/patch202112091.sh');
    ...
    */
    ...
    {
        $script = Storage::get('gitando/patch202112101.sh');
    ...
    */
    ...
    {
        $script = Storage::get('gitando/patch202112181.sh');
