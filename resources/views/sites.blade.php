            ...
            <div class="card mb-4">
                <div class="card-header text-right">
                    <button class="btn btn-sm btn-secondary" id="newSite">
                        <i class="fas fa-plus mr-1"></i><b>{{ __('gitando.new_button', ['type' => __('gitando.site')]) }}</b>
                    </button>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dt" width="100%" cellspacing="0">
                            <thead>
                            <tr>
                                <th class="text-center">{{ __('gitando.domain') }}</th>
                                <th class="text-center text-center d-none d-md-table-cell">{{ __('gitando.aliases') }}</th>
                                <th class="text-center d-none d-lg-table-cell">{{ __('gitando.server') }}</th>
                                <th class="text-center d-none d-xl-table-cell">IP</th>
                                <th class="text-center">{{ __('gitando.actions') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
...
@section('extra')
        ...
        <div class="modal-dialog" role="document" id="newsitedialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newSiteModalLabel">{{ __('gitando.new_site_modal_title') }}</h5>
                ...
                <div class="modal-body">
                    <div id="newsiteform">
                        <label for="newsitedomain">{{ __('gitando.site_domain') }}</label>
                        <div class="input-group">
                            <input class="form-control" type="text" id="newsitedomain" placeholder="e.g. domain.ltd" autocomplete="off" />
                        </div>
                        <div class="space"></div>
                        <label for="newsiteserver">{{ __('gitando.server') }}</label>
                        <div class="input-group">
                            <select class="form-control" id="newsiteserver"></select>
                        </div>
                        <div class="space"></div>
                        <label for="newsiteprovider">{{ __('gitando.php_version') }}</label>
                        <div class="input-group">
                        ...
                        <div class="space"></div>
                        <label for="newsitebasepath">{{ __('gitando.site_base_path') }}</label>
                        <div class="input-group">
                    ...
                    <div id="newsiteok" class="d-none container">
                        <div class="row">
                            <div class="col-xs-12">
                                <p><b>{{ __('gitando.site_ready_message') }}</b></b>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                                <p>{{ __('gitando.domain') }}:<br><b><span id="newsitedomainok"></b></b></p>
                                <p>{{ __('gitando.server_ip') }}:<br><b><span id="newsiteip"></b></b></p>
                                <p>SSH {{ __('gitando.username') }}:<br><b><span id="newsiteusername"></b></p>
                                <p>SSH {{ __('gitando.password') }}:<br><b><span id="newsitepassword"></b></p>
                                <p>MySQL {{ __('gitando.database') }}:<br><b><span id="newsitedbname"></b></p>
                                <p>MySQL {{ __('gitando.username') }}:<br><b><span id="newsitedbusername"></b></p>
                                <p>MySQL {{ __('gitando.password') }}:<br><b><span id="newsitedbpassword"></b></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
                                <p>{{ __('gitando.document_root') }}:<br><b>/home/<span id="newsitebasepathuser"></span>/web/<span id="newsitebasepath"></b></p>
                            </div>
                        </div>
                        <div class="space"></div>
                        <div class="row">
                            <div class="col-xl-12 text-center">
                                <a href="" target="_blank" id="newsitepdf">
                                    <button class="btn btn-success" type="button"><i class="fas fa-file-pdf"></i> {{ __('gitando.download_site_data') }}</button>
                                </a>
                            </div>
                        </div>
                        <div class="space"></div>
    ...
    <div class="modal fade" id="deleteSiteModal" tabindex="-1" role="dialog" aria-labelledby="deleteSiteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteSiteModalLabel">{{ __('gitando.delete_site_modal_title') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="space"></div>
                    <div class="text-center">
                        <button class="btn btn-danger" type="button" id="delete">{{ __('gitando.delete') }} <i class="fas fa-circle-notch fa-spin d-none" id="loadingdelete"></i></button>
                    </div>
                    <div class="space"></div>
                </div>
            </div>
