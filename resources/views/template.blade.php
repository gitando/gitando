...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta charset="utf-8" />
        ...
        <title>{{ config('gitando.name') }} | @yield('title')</title>
        <meta name="gitando-version" content="{{ Storage::get('gitando/version.md') }}">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="/dashboard"><i class="fab fa-fw fa-linux"></i> {{ config('gitando.name') }}</a>
        ...
        <div id="layoutSidenav">
            ...
            <div id="mainloading" class="d-none">
                <p><i class="fas fa-circle-notch fa-spin" id="mainloadingicon"></i> {{ __('gitando.loading_data') }}...</p>
            </div>
            @yield('extra')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="errorModalLabel">{{ __('gitando.system_error') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>{{ __('gitando.unknown_error') }}</p>
                            <div class="space"></div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            $('#panelversion').html($('meta[name="gitando-version"]').attr('content'));
